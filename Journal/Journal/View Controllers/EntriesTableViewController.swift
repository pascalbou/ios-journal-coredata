...
//        if segue.identifier == "PresentCreateEntrySegue" {
//            if let detailVC = segue.destination as? CreateEntryViewController, let indexPath = tableView.indexPathForSelectedRow {
